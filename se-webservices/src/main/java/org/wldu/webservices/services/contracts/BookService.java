...
public class BookService {
    ...
    public Book addBooks(Book book){
        book.setId(null);
        // Ensure default timestamps are set if not handled by @PrePersist
    ...
    public Book updateBook(Long id, Book updatedBook) {
        return bookRepository.findById(id).map(book -> {
            ...
            // FIX: Set the BigDecimal price from the updatedBook
            // We use a null check to prevent overwriting with null if the field is missing in the request
